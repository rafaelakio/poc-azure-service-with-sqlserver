# Terraform Configuration for AWS - Link Manager
# This configuration creates the infrastructure needed to run Link Manager on AWS
...
resource "aws_secretsmanager_secret" "db_connection" {
  ...
  description = "Database connection string for Link Manager"
...
resource "aws_secretsmanager_secret_version" "db_connection" {
  ...
  secret_string = "Server=${aws_db_instance.sqlserver.endpoint};Database=${var.database_name};User Id=${var.db_username};Password=${var.db_password};Encrypt=True;TrustServerCertificate=True;MultipleActiveResultSets=True;"
}
