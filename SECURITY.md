...
1. **Reporte Privadamente**
   - Use o recurso de [Security Advisories](https://github.com/rafaelakio/poc-azure-service-with-sqlserver/security/advisories/new) do GitHub
...
- **GitHub Security**: [Security Advisories](https://github.com/rafaelakio/poc-azure-service-with-sqlserver/security/advisories)

Para outras questões:
- **Issues**: [GitHub Issues](https://github.com/rafaelakio/poc-azure-service-with-sqlserver/issues)
